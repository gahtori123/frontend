...
import tichome from "../../../images/chess.webp";
...
const ChessHome = () => {
    ...
    if (socket) {
      ...
      socket.on("sendMessageRecieved", ({ gid, user }) => {
        setNotification((prev) => [
          ...prev,
          `${user.name} invited you to chessRoom:${gid} `,
        ]);
      });
  ...
  return (
    <div
      className="flex flex-col relative  items-center h-[1000px] bg-gray-100 p-4"
      style={{
